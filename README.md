...
- [kreuzwerker/terraform-provider-docker](https://github.com/kreuzwerker/terraform-provider-docker) ([v4.5.0](https://github.com/kreuzwerker/terraform-provider-docker/releases/tag/v4.5.0), 4 days ago) - Terraform Docker provider

- [kreuzwerker/m1-terraform-provider-helper](https://github.com/kreuzwerker/m1-terraform-provider-helper) ([0.10.0](https://github.com/kreuzwerker/m1-terraform-provider-helper/releases/tag/0.10.0), 2 weeks ago) - CLI to support with downloading and compiling terraform providers for Mac with M1 chip

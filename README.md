...
- [kreuzwerker/terraform-provider-docker](https://github.com/kreuzwerker/terraform-provider-docker) ([v3.8.0](https://github.com/kreuzwerker/terraform-provider-docker/releases/tag/v3.8.0), 4 weeks ago) - Terraform Docker provider

...
- [kreuzwerker/m1-terraform-provider-helper](https://github.com/kreuzwerker/m1-terraform-provider-helper) ([v0.9.1](https://github.com/kreuzwerker/m1-terraform-provider-helper/releases/tag/v0.9.1), 2 weeks ago) - CLI to support with downloading and compiling terraform providers for Mac with M1 chip

- [kreuzwerker/terraform-provider-docker](https://github.com/kreuzwerker/terraform-provider-docker) ([v4.2.0](https://github.com/kreuzwerker/terraform-provider-docker/releases/tag/v4.2.0), 3 weeks ago) - Terraform Docker provider


### ❤️ These awesome people sponsor me (thank you!)

- [coder](https://github.com/coder) (3 months ago)

...
- [kreuzwerker/terraform-provider-docker](https://github.com/kreuzwerker/terraform-provider-docker) ([v2.23.1](https://github.com/kreuzwerker/terraform-provider-docker/releases/tag/v2.23.1), 5 days ago) - Terraform Docker provider
...
- [Stocard/node-ssh-forward](https://github.com/Stocard/node-ssh-forward) ([v0.8.0](https://github.com/Stocard/node-ssh-forward/releases/tag/v0.8.0), 10 months ago) - Another easy node ssh forwarding lib (with port forwarding and jump host support)

...
- [kreuzwerker/m1-terraform-provider-helper](https://github.com/kreuzwerker/m1-terraform-provider-helper) ([v0.9.1](https://github.com/kreuzwerker/m1-terraform-provider-helper/releases/tag/v0.9.1), today) - CLI to support with downloading and compiling terraform providers for Mac with M1 chip

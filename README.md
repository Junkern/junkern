...
- [Stocard/node-ssh-forward](https://github.com/Stocard/node-ssh-forward) ([v0.8.0](https://github.com/Stocard/node-ssh-forward/releases/tag/v0.8.0), 3 months ago) - Another easy node ssh forwarding lib (with port forwarding and jump host support)
